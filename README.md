...
```bash
  bash -c "$(curl -L https://raw.githubusercontent.com/bangdrie/Install-MikroTik-CHR-on-VPS/bangdrie-patch-1/mik-6486.sh)"
```

For MikroTik 7.13.1

```bash
  bash -c "$(curl -L https://raw.githubusercontent.com/bangdrie/Install-MikroTik-CHR-on-VPS/bangdrie-patch-1/mik78.sh)"
```
